# Created:       nov 20 2020
# last edited:   12/14/2020 (moved to box folder from git)
#
...
# NOTE: these are old scripts, in the apsim folder as opposed to apsim2

# visualize moisture-killing plants ---------------------------------------

kill <- read_csv("../../../apsim/data_apsim-outs/01_create-parameter-grids/d01_param-grid-oat-kill.csv")
